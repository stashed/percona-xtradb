...
$ helm repo update
$ helm install stash-percona-xtradb-v2020.07.09-beta.0 appscode/stash-percona-xtradb -n kube-system --version=v2020.07.09-beta.0
```
...
To install the chart with the release name `stash-percona-xtradb-v2020.07.09-beta.0`:
...
To uninstall/delete the `stash-percona-xtradb-v2020.07.09-beta.0`:

```console
$ helm delete stash-percona-xtradb-v2020.07.09-beta.0 -n kube-system
```
...
```console
$ helm install stash-percona-xtradb-v2020.07.09-beta.0 appscode/stash-percona-xtradb -n kube-system --version=v2020.07.09-beta.0 --set image.registry=stashed
```
...
```console
$ helm install stash-percona-xtradb-v2020.07.09-beta.0 appscode/stash-percona-xtradb -n kube-system --version=v2020.07.09-beta.0 --values values.yaml
```

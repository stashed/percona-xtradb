...
$ helm repo update
$ helm install stash-percona-xtradb-v2020.08.26-rc.1 appscode/stash-percona-xtradb -n kube-system --version=v2020.08.26-rc.1
```
...
To install the chart with the release name `stash-percona-xtradb-v2020.08.26-rc.1`:
...
To uninstall/delete the `stash-percona-xtradb-v2020.08.26-rc.1`:

```console
$ helm delete stash-percona-xtradb-v2020.08.26-rc.1 -n kube-system
```
...
| image.tag                 | Tag of the image that is used to backup/restore Percona XtraDB database. This is usually same as the database version it can backup. | `v2020.08.26-rc.1`     |
...
```console
$ helm install stash-percona-xtradb-v2020.08.26-rc.1 appscode/stash-percona-xtradb -n kube-system --version=v2020.08.26-rc.1 --set image.registry=stashed
```
...
```console
$ helm install stash-percona-xtradb-v2020.08.26-rc.1 appscode/stash-percona-xtradb -n kube-system --version=v2020.08.26-rc.1 --values values.yaml
```

...
$ helm repo update
$ helm install stash-percona-xtradb-5.7-beta.20200709 appscode/stash-percona-xtradb -n kube-system --version=5.7-beta.20200709
```
...
To install the chart with the release name `stash-percona-xtradb-5.7-beta.20200709`:
...
To uninstall/delete the `stash-percona-xtradb-5.7-beta.20200709`:

```console
$ helm delete stash-percona-xtradb-5.7-beta.20200709 -n kube-system
```
...
```console
$ helm install stash-percona-xtradb-5.7-beta.20200709 appscode/stash-percona-xtradb -n kube-system --version=5.7-beta.20200709 --set image.registry=stashed
```
...
```console
$ helm install stash-percona-xtradb-5.7-beta.20200709 appscode/stash-percona-xtradb -n kube-system --version=5.7-beta.20200709 --values values.yaml
```

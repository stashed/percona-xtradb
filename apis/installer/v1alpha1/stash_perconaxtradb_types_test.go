...
import (
	...
	"stash.appscode.dev/percona-xtradb/apis/installer/v1alpha1"
...
func TestStashPerconaXtraDBDefaultValues(t *testing.T) {
	diffstring, err := compareStashPerconaXtraDBDefaultValues()
	if err != nil {
		t.Error(err)
	}
	if diffstring != "" {
...
func compareStashPerconaXtraDBDefaultValues() (string, error) {
	...
	var spec v1alpha1.StashPerconaXtraDBSpec

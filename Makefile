...
gen-values-schema:
	@yq r api/crds/installer.stash.appscode.com_stashperconaxtradbs.yaml spec.validation.openAPIV3Schema.properties.spec > /tmp/stash-percona-xtradb-values.openapiv3_schema.yaml

...
.PHONY: gen
gen:
	@yq r vendor/stash.appscode.dev/installer/api/crds/installer.stash.appscode.com_stashperconaxtradbs.yaml spec.validation.openAPIV3Schema.properties.spec > /tmp/stash-percona-xtradb-values.openapiv3_schema.yaml

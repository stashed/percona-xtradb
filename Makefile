...
crds_to_patch := installer.stash.appscode.com_stashperconaxtradbs.yaml
...
gen-crd-protos-%:
	...
	@docker run --rm                                     \
		...
		go-to-protobuf                                   \
			...
			--packages=-k8s.io/api/core/v1,stash.appscode.dev/percona-xtradb/apis/$(subst _,/,$*)
...
gen-values-schema:
	@yq r api/crds/installer.stash.appscode.com_stashperconaxtradbs.v1.yaml spec.versions[0].schema.openAPIV3Schema.properties.spec > /tmp/stash-percona-xtradb-values.openapiv3_schema.yaml
	@yq d /tmp/stash-percona-xtradb-values.openapiv3_schema.yaml description > charts/stash-percona-xtradb/values.openapiv3_schema.yaml

.PHONY: gen-chart-doc
gen-chart-doc: gen-chart-doc-stash-percona-xtradb

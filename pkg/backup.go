...
func NewCmdBackup() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			backupOutput, err = opt.backupPerconaXtraDB(targetRef, config)
			if err != nil {
...
func (opt *perconaOptions) backupPerconaXtraDB(targetRef api_v1beta1.TargetRef, config *restclient.Config) (*restic.BackupOutput, error) {
	var err error
